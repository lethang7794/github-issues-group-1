...
- [ ] If the repository does not exist, the user should see a proper error message. => Thắng, Tuấn đang làm?! 
- [ ] The user should be able to see the following information for each issue: => Ngọc
  ...
  - Body of the Issue
  - Labels of the issue
- [ ] The user should be able to see multiple pages of results, by clicking a pagination control.=> Hà
